...
function WhyUs() {
  ...
  return (
    <div className='h-full w-full pt-10 pl-4 pr-4'>
        <div className='max-w-6xl rounded-[34px] md:w-[77.03vw] w-full bg-white mx-auto py-12 sm:py-10 md:px-10 lg:py-14 lg:px-12 ' style={{ boxShadow: "0px 4px 65px rgba(0, 0, 0, 0.02)" }}>
  ...
  {loanFeatures.map((feature, index) => (
    <div
      ...
      "
    >
      {/* <div className="h-[48px] w-[48px] rounded-full absolute -top-7 bg-[#003474]"></div> */}
      <img src={feature.icon} alt={feature.title} className='h-[48px] w-[48px] absolute -top-6'/>
